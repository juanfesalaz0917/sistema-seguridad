...
//yup me ayuda a definir reglas de validacion para los formularios
//formik me ayuda a manejar el estado del formulario, validaciones y envios de alertas
...
const UserFormValidator: React.FC<MyFormProps> = ({ mode, handleCreate, handleUpdate,user }) => {
    ...
    return (
        <Formik
            initialValues={user ? user :{ //Inicializamos los valores del formulario, 

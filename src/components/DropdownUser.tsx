...
const DropdownUser = () => {
    ...
    // ✅ Logout con redirección a Sign In
    const handleLogout = () => {
        securityService.logout();
        setDropdownOpen(false); // Cierra el dropdown
        navigate('/auth/signin'); // Redirige al login
    };
        ...
        <div className="relative">
            ...
            >
                ...
                <button
                    ...
                    onClick={handleLogout} // ✅ Logout y redirección
                >
                    <svg
                        className="fill-current"
                        width="22"
